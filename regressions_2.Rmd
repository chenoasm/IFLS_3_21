...
data_heck <- clean %>% 
                select(jl_2, jl_year_fired, employed2, job_cat_H, age, age_sq, wage_prof, wage_rate, tk23a2y, job_cat, dl06, dependents_young, dependents_old, working_dependents, other_HHM, other_working, sc_code, wave, tk22a) %>%
...
stargazer(heckit1, heckit1_interact, heckit2, title="Estimation of Hours with Heckman Correction", align=TRUE, no.space=TRUE, style = "aer") 
