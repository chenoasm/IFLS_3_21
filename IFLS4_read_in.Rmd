...
#subset
B3A_TK2 <- B3A_TK2 %>%
                select(pid07, hhid07, hhid07_9, pidlink, tk22a, tk23a, tk24a, tk24a5, tk25a1x, tk25a1, tk25a2, tk26a1, tk26a3)
...
husbands <- merged %>%
              ...
              select(hhid07, pid07, age, tk24a, tk24a5, tk25a1x, tk25a1, tk25a2, tk26a1, tk26a3, tk46a, tk46b, tk46c, tk46dm, tk46dy, tk46m, tk01, tk01a, tk03, tk04, tk05, tk06a, tk07, dl04, dl06, dl06x, ar14)
...
household_mother_summary <- BK_AR1 %>%
                            ...
                            summarize(dependents = sum(ar09 < 15), working_dependents = sum(ar09 < 15 & ar15a == 1))
