...
#subset
B3A_TK2 <- B3A_TK2 %>%
                select(pid14, hhid14, hhid14_9, pidlink, tk22a, tk23a, tk24a, tk25a1x, tk24a5, tk25a1, tk25a2, tk26a1, tk26a3)
...
husbands <- merged %>%
              ...
              select(hhid14, pid14, age, tk24a, tk24a5, tk25a1x, tk25a1, tk25a2, tk26a1, tk26a3, tk46a, tk46b, tk46c, tk46dm, tk46dy, tk46m, tk01, tk01a, tk03, tk04, tk05, tk06a, tk07, dl04, dl06, dl06x, ar14)
...
#no dependents coded as NA due to wives not being matches, change to 0
wives$dependents <- ifelse(is.na(wives$dependents), 0, wives$dependents)
wives$working_dependents <- ifelse(is.na(wives$working_dependents), 0, wives$working_dependents)
