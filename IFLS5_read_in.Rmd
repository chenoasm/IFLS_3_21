...
#subset
B3A_TK2 <- B3A_TK2 %>%
                select(pid14, hhid14, hhid14_9, pidlink, tk22a, tk23a, tk24a, tk25a1x, tk25a1, tk25a2)
...
husbands <- merged %>%
              ...
              select(hhid14, pid14, tk24a, tk25a1x, tk25a1, tk25a2, tk46a, tk46b, tk46c, tk46m, tk01, tk01a, tk03, tk04, tk05, tk06a, tk07, dl06, dl06x, ar14)
...
wives <- left_join(wives, husbands, by = c("hhid14"= "hhid14", "ar14" = "pid14_H", "pid14" = "ar14_H"))
...
household_mother_summary <- BK_AR1 %>%
                        group_by(hhid14) %>%
                        mutate(all_members = n(), all_working = sum(as.numeric(ar15a) == 1)) %>%
                        group_by(hhid14, ar11) %>%
                        summarize(dependents = sum(ar09 < 15), working_dependents = sum(ar09 < 15 & as.numeric(ar15a) == 1), other_HHM =  mean(all_members) - sum(ar09 <15), other_working = mean(all_working) - sum(ar09 < 15 & as.numeric(ar15a) == 1))
...
wives$tk01 <- ifelse(wives$tk01 == "95:Other", NA, wives$tk01)
wives$tk01_H <- ifelse(wives$tk01_H == "95:Other", NA, wives$tk01_H)



#recode tk01a, tk03, tk24
wives$tk01a <- ifelse(wives$tk01a ==  "8:Don't Know", NA, wives$tk01a)
wives$tk03 <- ifelse(wives$tk03 == "8:Don't Know", NA, wives$tk03)
wives$tk24a <- ifelse(wives$tk24a == "8:Don't Know", NA, wives$tk24a)
