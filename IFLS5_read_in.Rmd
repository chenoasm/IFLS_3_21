...
household_mother_summary <- BK_AR1 %>%
                        ...
                        summarize(dependents = sum(ar09 < 15), working_dependents = sum(ar09 < 15 & as.numeric(ar15a) == 1))
...
wives <- wives %>%
            ...
            mutate (dependents = ifelse(is.na(dependents), 0, dependents), working_dependents = ifelse(is.na(working_dependents), 0, working_dependents))
