...
IFLS_4_5$wage_prof_H <- ifelse(!(is.na(IFLS_4_5$tk25a1)), IFLS_4_5$tk25a1, ifelse(!(is.na(IFLS_4_5$tk26a1)), IFLS_4_5$tk26a1, NA))
...
IFLS_4_5 <- IFLS_4_5 %>%
              filter(age >= 16, age_H >= 16, age<80, age_H <80)
