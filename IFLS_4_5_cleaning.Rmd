...
IFLS_4_5$wage_prof_H <- ifelse(!(is.na(IFLS_4_5$tk25a1_H)), IFLS_4_5$tk25a1_H, ifelse(!(is.na(IFLS_4_5$tk26a1_H)), IFLS_4_5$tk26a1_H, NA))
...
IFLS_4_5 <- IFLS_4_5 %>%
            filter(!(is.na(clean$wage_prof_H)) & as.numeric(clean$job_cat_H) == 1)
